...
contract MarketplaceSettings is Ownable, AccessControl, IMarketplaceSettings {
    ...
    //chimera
    // Mapping of ERC721 contract to mapping of token ID to whether the token is physical or virtual.
    mapping(address => mapping(uint256 => bool)) private physicalTokens;
    
    //chimera
    //mapping of ERC721 contract to mapping of NFT holder addresses to store physicalTokens Id's.
    ...
    //chimera
    /////////////////////////////////////////////////////////////////////////
    //isERC721TokenPhysical
    /////////////////////////////////////////////////////////////////////////
    /**
     * @dev Check whether the ERC721 token is physical.
     * @param _contractAddress address ERC721Contract address.
     * @param _tokenId uint256 token ID.
     * @return bool of whether the token is physical.
     */
    ...
    /////////////////////////////////////////////////////////////////////////
    // markERC721TokenAsPhysical
    /////////////////////////////////////////////////////////////////////////
    /**
     * @dev Mark a token as physical.
     ...
     * @param _contractAddress address ERC721Contract address.
     * @param _tokenId uint256 token ID.
     * @param _hasSold bool of whether the token should be marked physical or not.
     */
